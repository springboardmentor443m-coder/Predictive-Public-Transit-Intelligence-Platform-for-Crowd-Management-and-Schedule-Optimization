...
export const AlertsPage: React.FC = () => {
  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <p className="text-[11px] font-mono text-slate-500 italic text-center pt-2">
        Note: Delay notifications are generated by a model trained on synthetic data. This data was built using real Seoul Metro station identities and real historical crowd patterns, but delay probabilities themselves are simulated, not observed real-world delay records.
      </p>
    </div>
  );
};
