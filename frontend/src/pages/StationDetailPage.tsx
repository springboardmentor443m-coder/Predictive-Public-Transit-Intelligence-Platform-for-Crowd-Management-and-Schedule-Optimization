    ...
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="bg-bg-surface border border-border-dark rounded-2xl p-6 shadow-card space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-base font-bold text-slate-100">
            Downstream Delay Propagation Estimator
          </h3>
        </div>
        <p className="text-xs font-mono text-slate-400">
          Simulate an operational delay incident at {station.name_en} and estimate downstream delay impact across connecting stations along {station.line} using the Random Forest delay prediction classifier.
        </p>
        ...
        <form onSubmit={handleReportDelay} className="flex flex-wrap items-center gap-4 pt-2">
          ...
          >
            ...
            <span>{reportingDelay ? 'Computing...' : 'Estimate Delay Propagation'}</span>
          </button>
        </form>
        ...
        <p className="text-[11px] font-mono text-slate-500 italic pt-1 border-t border-border-dark/30">
          Note: Delay predictions are generated by a model trained on synthetic data. This data was built using real Seoul Metro station identities and real historical crowd patterns, but delay probabilities themselves are simulated, not observed real-world delay records.
        </p>
      </div>
    </div>
  );
