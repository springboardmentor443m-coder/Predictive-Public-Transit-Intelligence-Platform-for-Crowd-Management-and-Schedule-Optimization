...
Switch the branch dropdown from main to your own branch (create it first via Branch: main → View all branches → New branch, named after yourself).
Once on your branch, use Add file → Upload files to upload your code.
Commit directly to your branch (not main).
3. Rules
